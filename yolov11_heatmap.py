...
def get_params():
    params = {
        'weight': '/home/i/PRNet/runs/detect/PRNet-VisDrone2/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'GradCAM', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM, KPCA_CAM 30, 33,
        'layer': [37],
...
if __name__ == '__main__':
    ...
    model(r'/home/i/PRNet/VisDrone-Select/9999951_00000_d_0000317.jpg', 'result')
